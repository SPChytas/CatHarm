...
class AttentionWithoutShortcutsLayer(nn.Module):
    ...
    def forward(self,
                ...
                attention_mask: Optional[torch.Tensor] = None) -> Tuple[torch.Tensor, Optional[dict]]:
        """
        ...
        if query_2 is None:
            ...
            if need_weights:
                return self.W_O(concatenated_attns), cache_weights
            else:
                return self.W_O(concatenated_attns), None
