...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.heads = nn.Sequential(nn.Linear(hidden_dim, final_latent_space_dim))
        ...
        #     nn.init.zeros_(self.heads.head.weight).pos_embedding
    ...
    def forward(self, x: torch.Tensor):
        ...
        # "token" as used by standard language architectures
        x = x[:, 0]
